...
@SpringBootTest(properties = {"spring.application.name=testConsulLoadBalancer","spring.cloud.consul.discovery.prefer-ip-address=true", "spring.cloud.consul.discovery.metadata.foo=bar"},webEnvironment = RANDOM_PORT)
