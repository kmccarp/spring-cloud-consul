...
@SpringBootTest(classes = ConsulAutoServiceRegistrationCustomizedManagementServicePortTests.TestConfig.class,properties = {"spring.application.name=myTestService-GG",
